...
module.exports = {
    ...
    execute: async (interaction) => {
        ...
        const bakimmodu = new EmbedBuilder()
            ...
            .setDescription(`Herhangi bir sorunuz vs. varsa <@885598994129096725>'e ulaşınız!`);

        if (db.fetch(`bakim`)) {
            if (interaction.user.id !== "885598994129096725") { return interaction.reply({ embeds: [bakimmodu]}) }
        }
